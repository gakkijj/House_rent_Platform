    ...
    <c:forEach items="${house.slideImgList}" var="url">
        <div class="featured_slick_padd">
            <a href="${url}" class="mfp-gallery">
                <img src="${url}" style="width: 95%;height: 300px;" class="img-fluid mx-auto">
            </a>
        </div>
    </c:forEach>
</div>
                    ...
                    <div id="clOne" class="panel-collapse collapse show">
                        <div class="block-body">
                            <ul class="deatil_features">
                                ...
                                <li><strong>房屋/房间面积：</strong>${house.area}㎡</li>
                                <li>
                                    <strong>是否有空调：</strong>
                                    <c:choose>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${c.currentOrder!=null}">
                                                                    <div class="comment-text">
                                                                        <p>性别：${c.currentOrder.customerUser.sex}</p>
                                                                        <p>职业：${c.currentOrder.customerUser.job}</p>
                                                                        ...
                                                                        <p>结束日期：<fmt:formatDate value="${c.currentOrder.endDate}" pattern="yyyy-MM-dd"></fmt:formatDate></p>
                                                                    </div>
                                                                </c:when>
                                                                <c:otherwise>
                ...
                <div class="property-sidebar">
                    <div class="like_share_wrap b-0">
                        <ul class="like_share_list">
                            <li>
                                <a href="javascript:void(0)" class="btn btn-likes" onclick="submitMark(${house.id})">
                                    ...
                                    <div class="form-group">
                                        <c:choose>
                                            <c:when test="${house.status == 0}">
                                                <a href="javascript:void(0);" class="btn btn-md full-width btn-theme bg-3" onclick="createOrder()">立即预定</a>
                                            </c:when>
                        ...
                        <div class="side-block-body">
                            <form id="contactForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                        <div class="form-group">
                                            <textarea class="form-control" name="content" placeholder="想要发的内容"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                        <div class="form-group">
