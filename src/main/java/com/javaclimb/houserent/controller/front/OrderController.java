...
public class OrderController extends BaseController {
     ...
     * 创建订单
     */
    @RequestMapping("/legacy/order/create")
    @ResponseBody
     ...
     * 查看合同信息
     */
    @RequestMapping("/legacy/order/agreement/view")
     ...
     * 签订合同
     */
    @RequestMapping("/legacy/order/agreement/submit")
    @ResponseBody
     ...
     * 转向支付页面
     */
    @RequestMapping("/legacy/order/pay")
...
//        order.setOwnerUser(userService.get(order.getOwnerUserId()));
     ...
     * 模拟支付
     */
    @RequestMapping("/legacy/order/pay/submit")
    @ResponseBody
    public JsonResult paySubmit(@RequestParam(value = "orderId")Long orderId){
        ...
        return JsonResult.success("支付成功！请联系房东入住",orderId);
    }

    /**
     * 联系房东的方法
     */
    @RequestMapping("/legacy/house/contact")
    @ResponseBody
