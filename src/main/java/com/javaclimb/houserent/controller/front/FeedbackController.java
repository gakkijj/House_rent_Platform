...
public class FeedbackController extends BaseController {
    ...
    @RequestMapping("/legacy/feedback")
     ...
     * 反馈提交
     */
    @RequestMapping(value = "/legacy/feedback/submit",method = RequestMethod.POST)
    @ResponseBody
    public JsonResult submit(@RequestParam("contactName")String contactName,
        ...
        if (contactName.equals("") || contactEmail.equals("") || title.equals("") || content.equals("")){
            return JsonResult.error("请完善反馈信息");
        }
        ...
        return JsonResult.success("反馈成功，最迟将于七日内回复，请耐心等待");
    }
}
