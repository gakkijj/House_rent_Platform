...
public class HouseController extends BaseController {
     ...
     * 房子详情
     */
    @RequestMapping("/legacy/house/detail/{id}")
    public String houseDetail(@PathVariable("id")Long id, Model model){
        ...
        //如果是合租，查询合租房子
        List<House> shareHouseList = houseService.findByUserIdAndCertificateNoAndRentType(house.getUserId(),
                house.getCertificateNo(), HouseRentTypeEnum.SHARE.getValue());
        //从订单里查找到租户，把租户放到每个房子里
     ...
     * 房子地图页面
     */
    @RequestMapping("/legacy/house/map")
