...
public class UserController extends BaseController {
     ...
     * 禁用用户
     */
    @RequestMapping("/legacy/admin/user/disable")
    @ResponseBody
     ...
     * 启用用户
     */
    @RequestMapping("/legacy/admin/user/enable")
    @ResponseBody
     ...
     * 进入修改密码页面
     */
    @RequestMapping("/legacy/admin/password")
     ...
     * 修改密码
     */
    @RequestMapping("/legacy/admin/password/submit")
    @ResponseBody
    public JsonResult passwordSubmit(@RequestParam("oldPassword")String oldPassword, @RequestParam("newPassword")String newPassword,
        ...
        if (Objects.equals(oldPassword,newPassword)){
            return JsonResult.error("新密码与原密码相同！");
        }
