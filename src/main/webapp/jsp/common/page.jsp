...
<c:if test="${pageInfo.getPages()>1}">
    <ul class="pagination p-center">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <li class="page-item">
                    <a class="page-link" href="${pagePrefix}&page=${pageInfo.current-1}" aria-lable="Previous">
        ...
        <c:if test="${begin >= 2}">
            <li class="page-item">
                <a class="page-link" href="${pagePrefix}&page=1">
                    1
                </a>
            </li>
        </c:if>
            ...
            <c:choose>
                <c:when test="${i eq pageInfo.current}">
                    <li class="page-item active">
                        <a class="page-link" href="${pagePrefix}&page=${i}">
                            ${i}
                        </a>
                    </li>
                </c:when>
                <c:otherwise>
                    <c:if test="${i <= pageInfo.getPages()}">
                        <li class="page-item">
                            <a class="page-link" href="${pagePrefix}&page=${i}">
                                    ${i}
                            </a>
        ...
        <c:if test="${end < pageInfo.getPages()}">
            <li class="page-item">
                <a class="page-link" href="${pagePrefix}&page=${pageInfo.getPages()}">
                    ${pageInfo.getPages()}
                </a>
            </li>
        </c:if>
