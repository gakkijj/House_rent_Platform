...
<div class="col-lg-3 col-md-4 col-sm-12" style="min-height: 600px">
    <div class="property_dashboard_navbar">
        <div class="dash_user_menues">
            <ul>
                <li <c:if test="${tab == 'my-profile'}"> class="active"</c:if>>
                    <a href="/admin/profile" style="color: whitesmoke">
                        <i class="ti-user"></i>&nbsp;个人信息
                    </a>
                </li>
                <li <c:if test="${tab == 'home'}"> class="active"</c:if>>
                    <a href="/admin/home" style="color: whitesmoke">
                ...
                <c:if test="${sessionScope.user.role == 'admin'}">
                    <li <c:if test="${tab == 'feedback-list'}"> class="active"</c:if> >
                        <a href="/admin/feedback" style="color: whitesmoke">
                ...
                <c:if test="${sessionScope.user.role == 'admin'}">
                    <li <c:if test="${tab == 'user-list'}"> class="active"</c:if> >
                        <a href="/admin/user" style="color: whitesmoke">
                            <i class="ti-user"></i>&nbsp;用户管理
                        </a>
                    </li>
                </c:if>
                <li <c:if test="${tab == 'password'}"> class="active"</c:if> >
                    <a href="/admin/password" style="color: whitesmoke">
