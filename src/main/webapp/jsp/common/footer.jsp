...
<footer class="dark-footer skin-dark-footer style-2" style="padding-top: 0">
    <div class="footer-bottom">
        <div class="container">
            <p class="mb-0" style="color: ghostwhite;">©2023爱租房</p>
        </div>
    </div>
</footer>
</body>
        ...
        <div class="modal-content" id="sign-up">
            <div class="modal-body">
                <form id="registerForm">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>电子邮箱</label>
                                <div class="input-with-icon">
                                    <input type="email" name="email" class="form-control" placeholder="电子邮箱用于重置密码">
                                    <i class="ti-email"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>账号</label>
                                <div class="input-with-icon">
                                    <input type="text" name="userName" class="form-control" placeholder="登陆账号">
                                    <i class="ti-user"></i>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>密码</label>
                                <div class="input-with-icon">
                                    <input type="password" name="userPass" class="form-control" placeholder="登陆密码">
                                    <i class="ti-unlock"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" onclick="submitRegister()" class="btn btn-md full-width pop-login bg-2">创建账户</button>
                    </div>
                </form>
            </div>
        </div>
