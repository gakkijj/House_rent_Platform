...
<div class="image-cover hero_banner" style="background: #334aca url('/assets/img/banner-2.jpg') no-repeat;" data-overlay="1">
    <div class="container">
        <h1 class="big-header-capt mb-0">开始一段美好的租房生活把！</h1>
        <p class="text-center mb-5">搜索你所在城市的小区或房屋类型把！</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center" >
                ...
                <span><i class="ti-arrow-right"></i></span></a>
            </div>
        </div>
    </div>
</section>
