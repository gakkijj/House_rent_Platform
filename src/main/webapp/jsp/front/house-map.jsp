...
<head>
    ...
    <script type="text/javascript"
            src="https://api.map.baidu.com/api?v=2.0&ak=IUtHCxA1nygONQP2DEF2dG2UAqSzHy55"></script>
</head>
<body>
...
<script type="text/javascript">
    ...
    map.addEventListener("click",function (e) {
        ...
        marker.addEventListener("dragend",function (e) {
            var p = marker.getPosition();//获得marker位置
    ...
    marker.addEventListener('click',function () {
        ...
        infoWindow.redraw();//防止在网速较慢，图片未加载时，生成的信息框高度比图片总高度小，导致图片部分被隐藏
    });
