                        ...
                        <table class="property-table-wrap responsive-table bkmark">
                            ...
                            <c:forEach items="${pageInfo.records}" var="c">
                                <tr>
                                    <td class="dashboard_propert_wrapper">
                                        ...
                                        <div class="title">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:when test="${c.status == -1}"><span class="text-warning">待收款</span> </c:when>
                                    ...
                                    <td>
                                        <a   href="/order/agreement/view?orderId=${c.id}" target="_blank">查看合同</a><br/>
                                        ...
                                        <c:if test="${c.status == 2 && (sessionScope.user.role == 'admin'||sessionScope.user.role =='owner')}">
                                            ...
                                            <a  href="javascript:void(0)" onclick="endOrderReject(${c.id})">退租申请不通过</a>
                                        </c:if>
