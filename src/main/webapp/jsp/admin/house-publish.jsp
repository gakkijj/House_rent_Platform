                                    ...
                                    <div class="submit-page form-simple">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="city" class="form-control">
                                                        ...
                                                        <option value="晋城"<c:if test="${house.city == '晋城'}">selected</c:if>>晋城</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-8">
                                                    <label>房子详细地址信息<a href="#" class="tip-topdata" data-tip="山西省晋城市南村镇四季花城小区112栋888室A卧"><i class="ti-help"></i> </a></label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label>经纬度坐标<a href="https://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank">点此获取</a>
                                                        <a href="#" class="tip-topdata" data-tip="经纬度  如：113.2345，22.5678"><i class="ti-help"></i> </a>
                                                    </label>
                                        ...
                                        <div class="frm_submit_block">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>面积<a href="#" class="tip-topdata" data-tip="整租类型时为整个房子的面积，合租类型为单间的面积"><i class="ti-help"></i> </a></label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="livingRoomNum" class="form-control">
                                                        <option value="0" <c:if test="${house.livingRoomNum == '0'}">selected</c:if>>0个</option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="kitchenNum" class="form-control">
                                                        <option value="0" <c:if test="${house.kitchenNum == '0'}">selected</c:if>>0个</option>
